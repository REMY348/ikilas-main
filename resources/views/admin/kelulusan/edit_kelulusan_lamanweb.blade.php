...
<form action="{{ route('update.kelulusan.lamanweb',$lulus->id) }}" method="post" enctype="multipart/form-data">
  @csrf
  ...
  <div class="card card-dark">
    ...
    <div class="card card-dark">
      <div class="card-header">
        <h3 class="card-title">Kelulusan Laman Web</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <div class="row">
              ...
              <div class="form-group">
                      ...
                      <select name="status" class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="3" tabindex="-1" aria-hidden="true">
                        ...
                        <option value="baru">Kembali Pada Sokongan Pegawai / Pengarah Jabatan</option>
