      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="form-group">
            <label for="exampleInputRounded0">Nama Jabatan</label>
            <input type="text" name="name" value="{{ $jabatan->name }}" class="form-control rounded-0" id="exampleInputRounded0" autofocus >
              @error('name')
