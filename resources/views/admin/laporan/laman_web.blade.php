...
<form action="{{ route('all.laporan.lamanweb') }}" method="get">
<!-- SELECT2 EXAMPLE -->
      ...
      <div class="row">
        ...
        <div class="col-3">
            <div class="form-group">
              ...
              <input type="date" value="{{ $date }}" name="tarikh_mula" class="form-control rounded-0" id="exampleInputRounded0" >
                @error('tarikh_mula')
        ...
        <div class="col-3">
            <div class="form-group">
              ...
              <input type="date" value="{{ $date_tamat }}" name="tarikh_tamat" class="form-control rounded-0" id="exampleInputRounded0" >
                @error('tarikh_tamat')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                    ...
                    <select name="status" class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="3" tabindex="-1" aria-hidden="true">
                      ...
                      <option value="disokong" {{ ($status == 'disokong') ? 'selected' : '' }}>Sokongan</option>
    ...
    <div class="col-12">
        <div class="card card-dark">
            <div class="card-header">
                <h6 class="float-left"><strong>Halaman Laporan Laman Web</strong></h6>
            </div>
        <div class="card-body">
            ...
            <tbody>
            <tr>
                <td class="text-center" colspan="10">Tiada Data Dijumpai</td>
            </tr>
    ...
    <div class="col-12">
        ...
        <div class="card-body">
            ...
            <tr>
                ...
                <td class="text-center">{{ $laporans->kategori_saluran_id }}</td>
                <td class="text-center">{{ $laporans->kategorimaklumat->name }}</td>
                <td class="text-center">{{ $laporans->jeniskemaskini->name }}</td>
                <td>{{ $laporans->tarikh_mula }} - {{ $laporans->tarikh_tamat }}</td>
