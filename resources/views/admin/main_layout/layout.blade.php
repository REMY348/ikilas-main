...
<div class="wrapper">
  @include('admin.main_layout.header')
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            @php
                ...
                $modelname1 = Request::segment(2);
                $uriname = Request::route()->uri();
            @endphp
            {{-- {{ dd($modelname1) }} --}}
            {{-- <h1 class="m-0">{{ ucfirst($prefix) }}</h1> --}}
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{ ucfirst($prefix) }}</li>
              @endif
              
                <li class="breadcrumb-item active">{{ ucfirst($modelname1)}}</li>
  ...
  @include('admin.main_layout.footer')
