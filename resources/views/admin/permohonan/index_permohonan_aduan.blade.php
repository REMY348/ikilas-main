    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="float-left"><strong>Halaman Permohonan Aduan</strong></h3>
                <a href="{{ route('add.permohonan.aduan') }}" class="btn btn-dark float-right" style="width: 178px"><small>Tambah Permohonan</small></a>
            </div>
        <div class="card-body">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('edit.permohonan.aduan',$mohon->id) }}"><span class="btn btn-info fa fa-edit" {{ ($mohon->status != 'baru_r') ? 'hidden' : '' }} title="Ubah"></span></a>
